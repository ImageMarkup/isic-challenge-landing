<template>
  <div class="track-email">
    <div v-if="submitted" class="success">
      ...
      <ul>
        <li>
          <a href="https://s3.amazonaws.com/isic-challenge-data/2019/ISIC_2019_Training_Input.zip">ISIC_2019_Training_Input.zip</a><br>
          <i>25,331 JPEG images of skin lesions</i>
        </li>
        <li>
          <a href="https://s3.amazonaws.com/isic-challenge-data/2019/ISIC_2019_Training_Metadata.csv">ISIC_2019_Training_Metadata.csv</a><br>
          <i>25,331 metadata entries of age, sex, general anatomic site, and common lesion identifier</i>
        </li>
        <li>
          <a href="https://s3.amazonaws.com/isic-challenge-data/2019/ISIC_2019_Training_GroundTruth.csv">ISIC_2019_Training_GroundTruth.csv</a><br>
      ...
      <ul>
        <li>
          <a href="https://s3.amazonaws.com/isic-challenge-data/2019/ISIC_2019_Test_Input.zip">ISIC_2019_Test_Input.zip</a><br>
          <i>8,238 JPEG images of skin lesions</i>
        </li>
        <li>
          <a href="https://s3.amazonaws.com/isic-challenge-data/2019/ISIC_2019_Test_Metadata.csv">ISIC_2019_Test_Metadata.csv</a><br>
